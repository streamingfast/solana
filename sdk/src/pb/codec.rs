...
pub struct Block {
    ...
    pub root_num: u64,
    pub last_entry_hash: ::std::vec::Vec<u8>,
...
impl Block {
    ...
    pub fn get_last_entry_hash(&self) -> &[u8] {
    ...
    // Param is passed by value, moved
    pub fn set_last_entry_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.last_entry_hash = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_last_entry_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.last_entry_hash
    }

    // Take field
    pub fn take_last_entry_hash(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.last_entry_hash, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for Block {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.last_entry_hash)?;
                },
                10 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.previous_id.is_empty() {
            my_size += ::protobuf::rt::bytes_size(4, &self.previous_id);
        }
        ...
        if !self.last_entry_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(9, &self.last_entry_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.previous_id.is_empty() {
            os.write_bytes(4, &self.previous_id)?;
        }
        if self.previous_block != 0 {
        ...
        if !self.last_entry_hash.is_empty() {
            os.write_bytes(9, &self.last_entry_hash)?;
        }
        for v in &self.transactions {
...
impl AccountChangesPerTrxIndex {
    ...
    // Param is passed by value, moved
    pub fn set_TrxId(&mut self, v: ::std::vec::Vec<u8>) {
        self.TrxId = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_TrxId(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.TrxId
    }

    // Take field
    pub fn take_TrxId(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.TrxId, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for AccountChangesPerTrxIndex {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.TrxId)?;
                },
                2 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.TrxId.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.TrxId);
        }
...
pub struct Transaction {
    ...
    pub id: ::std::vec::Vec<u8>,
    pub index: u64,
    pub additional_signatures: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    pub header: ::protobuf::SingularPtrField<MessageHeader>,
    pub account_keys: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
...
impl Transaction {
    ...
    pub fn get_additional_signatures(&self) -> &[::std::vec::Vec<u8>] {
    ...
    // Param is passed by value, moved
    pub fn set_additional_signatures(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.additional_signatures = v;
    }

    // Mutable pointer to the field.
    pub fn mut_additional_signatures(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.additional_signatures
    }

    // Take field
    pub fn take_additional_signatures(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
    ...
    pub fn get_account_keys(&self) -> &[::std::vec::Vec<u8>] {
        &self.account_keys
    }
    ...
    // Param is passed by value, moved
    pub fn set_account_keys(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.account_keys = v;
    }

    // Mutable pointer to the field.
    pub fn mut_account_keys(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.account_keys
    }

    // Take field
    pub fn take_account_keys(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
    ...
    pub fn get_recent_blockhash(&self) -> &[u8] {
    ...
    // Param is passed by value, moved
    pub fn set_recent_blockhash(&mut self, v: ::std::vec::Vec<u8>) {
        self.recent_blockhash = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_recent_blockhash(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.recent_blockhash
    }

    // Take field
    pub fn take_recent_blockhash(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.recent_blockhash, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for Transaction {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.additional_signatures)?;
                },
                4 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.header)?;
                },
                5 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.account_keys)?;
                },
                6 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.recent_blockhash)?;
                },
                7 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.recent_blockhash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(6, &self.recent_blockhash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.recent_blockhash.is_empty() {
            os.write_bytes(6, &self.recent_blockhash)?;
        }
...
impl Instruction {
    ...
    // Param is passed by value, moved
    pub fn set_program_id(&mut self, v: ::std::vec::Vec<u8>) {
        self.program_id = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_program_id(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.program_id
    }

    // Take field
    pub fn take_program_id(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.program_id, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for Instruction {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                3 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.program_id)?;
                },
                4 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.account_keys)?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.program_id.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.program_id);
        }
        for value in &self.account_keys {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.program_id.is_empty() {
            os.write_bytes(3, &self.program_id)?;
        }
        for v in &self.account_keys {
            os.write_bytes(4, &v)?;
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\x04R\x07rootNum\x12&\n\x0flast_entry_hash\x18\t\x20\x01(\x0cR\
    \rlastEntryHash\x12C\n\x0ctransactions\x18\n\x20\x03(\x0b2\x1f.sf.solana\
    ...
    rxId\x18\x01\x20\x01(\x0cR\x05TrxId\x12T\n\x0cinstructions\x18\x02\x20\
    \x03(\x0b20.sf.solana.codec.v1.AccountChangesPerInstructionR\x0cinstruct\
    ions\"[\n\x1cAccountChangesPerInstruction\x12;\n\x07changes\x18\x01\x20\
    \x03(\x0b2!.sf.solana.codec.v1.AccountChangeR\x07changes\"\xad\x03\n\x0b\
    Transaction\x12\x0e\n\x02id\x18\x01\x20\x01(\x0cR\x02id\x12\x14\n\x05ind\
    ex\x18\x02\x20\x01(\x04R\x05index\x123\n\x15additional_signatures\x18\
    \x03\x20\x03(\x0cR\x14additionalSignatures\x129\n\x06header\x18\x04\x20\
    \x01(\x0b2!.sf.solana.codec.v1.MessageHeaderR\x06header\x12!\n\x0caccoun\
    t_keys\x18\x05\x20\x03(\x0cR\x0baccountKeys\x12)\n\x10recent_blockhash\
    \x18\x06\x20\x01(\x0cR\x0frecentBlockhash\x12!\n\x0clog_messages\x18\x07\
    \x20\x03(\tR\x0blogMessages\x12C\n\x0cinstructions\x18\x08\x20\x03(\x0b2\
    \x1f.sf.solana.codec.v1.InstructionR\x0cinstructions\x12\x16\n\x06failed\
    \x18\t\x20\x01(\x08R\x06failed\x12:\n\x05error\x18\n\x20\x01(\x0b2$.sf.s\
    olana.codec.v1.TransactionErrorR\x05error\"\xcd\x01\n\rMessageHeader\x12\
    6\n\x17num_required_signatures\x18\x01\x20\x01(\rR\x15numRequiredSignatu\
    res\x12?\n\x1cnum_readonly_signed_accounts\x18\x02\x20\x01(\rR\x19numRea\
    donlySignedAccounts\x12C\n\x1enum_readonly_unsigned_accounts\x18\x03\x20\
    \x01(\rR\x1bnumReadonlyUnsignedAccounts\"\xa6\x03\n\x0bInstruction\x12\
    \x1d\n\nprogram_id\x18\x03\x20\x01(\x0cR\tprogramId\x12!\n\x0caccount_ke\
    ys\x18\x04\x20\x03(\x0cR\x0baccountKeys\x12\x12\n\x04data\x18\x05\x20\
    \x01(\x0cR\x04data\x12\x18\n\x07ordinal\x18\x06\x20\x01(\rR\x07ordinal\
    \x12%\n\x0eparent_ordinal\x18\x07\x20\x01(\rR\rparentOrdinal\x12\x14\n\
    \x05depth\x18\x08\x20\x01(\rR\x05depth\x12J\n\x0fbalance_changes\x18\t\
    \x20\x03(\x0b2!.sf.solana.codec.v1.BalanceChangeR\x0ebalanceChanges\x12J\
    \n\x0faccount_changes\x18\n\x20\x03(\x0b2!.sf.solana.codec.v1.AccountCha\
    ngeR\x0eaccountChanges\x12\x16\n\x06failed\x18\x0f\x20\x01(\x08R\x06fail\
    ed\x12:\n\x05error\x18\x10\x20\x01(\x0b2$.sf.solana.codec.v1.Instruction\
    ErrorR\x05error\"o\n\rBalanceChange\x12\x16\n\x06pubkey\x18\x01\x20\x01(\
    \x0cR\x06pubkey\x12#\n\rprev_lamports\x18\x02\x20\x01(\x04R\x0cprevLampo\
    rts\x12!\n\x0cnew_lamports\x18\x03\x20\x01(\x04R\x0bnewLamports\"\x87\
    \x01\n\rAccountChange\x12\x16\n\x06pubkey\x18\x01\x20\x01(\x0cR\x06pubke\
    y\x12\x1b\n\tprev_data\x18\x02\x20\x01(\x0cR\x08prevData\x12\x19\n\x08ne\
    w_data\x18\x03\x20\x01(\x0cR\x07newData\x12&\n\x0fnew_data_length\x18\
    \x04\x20\x01(\x04R\rnewDataLength\"\x80\x01\n\x10TransactionError\x12<\n\
    \x04type\x18\x01\x20\x01(\x0e2(.sf.solana.codec.v1.TransactionErrorTypeR\
    \x04type\x12.\n\x07payload\x18\x02\x20\x01(\x0b2\x14.google.protobuf.Any\
    R\x07payload\"o\n\x1bTransactionInstructionError\x12\x14\n\x05Index\x18\
    \x01\x20\x01(\rR\x05Index\x12:\n\x05error\x18\x02\x20\x01(\x0b2$.sf.sola\
    na.codec.v1.InstructionErrorR\x05error\"\x80\x01\n\x10InstructionError\
    \x12<\n\x04type\x18\x02\x20\x01(\x0e2(.sf.solana.codec.v1.InstructionErr\
    orTypeR\x04type\x12.\n\x07payload\x18\x03\x20\x01(\x0b2\x14.google.proto\
    buf.AnyR\x07payload\"(\n\x16InstructionErrorCustom\x12\x0e\n\x02id\x18\
    \x01\x20\x01(\rR\x02id*\xbc\x03\n\x14TransactionErrorType\x12\x12\n\x0eA\
    CCOUNT_IN_USE\x10\0\x12\x18\n\x14ACCOUNT_LOADED_TWICE\x10\x01\x12\x15\n\
    \x11ACCOUNT_NOT_FOUND\x10\x02\x12\x1d\n\x19PROGRAM_ACCOUNT_NOT_FOUND\x10\
    \x03\x12\x1e\n\x1aINSUFFICIENT_FUNDS_FOR_FEE\x10\x04\x12\x1b\n\x17INVALI\
    D_ACCOUNT_FOR_FEE\x10\x05\x12\x17\n\x13DUPLICATE_SIGNATURE\x10\x06\x12\
    \x17\n\x13BLOCKHASH_NOT_FOUND\x10\x07\x12\x15\n\x11INSTRUCTION_ERROR\x10\
    \x08\x12\x17\n\x13CALL_CHAIN_TOO_DEEP\x10\t\x12\x1d\n\x19MISSING_SIGNATU\
    RE_FOR_FEE\x10\n\x12\x19\n\x15INVALID_ACCOUNT_INDEX\x10\x0b\x12\x15\n\
    \x11SIGNATURE_FAILURE\x10\x0c\x12!\n\x1dINVALID_PROGRAM_FOR_EXECUTION\
    \x10\r\x12\x14\n\x10SANITIZE_FAILURE\x10\x0e\x12\x17\n\x13CLUSTER_MAINTE\
    NANCE\x10\x0f*\xce\t\n\x14InstructionErrorType\x12\x11\n\rGENERIC_ERROR\
    \x10\0\x12\x14\n\x10INVALID_ARGUMENT\x10\x01\x12\x1c\n\x18INVALID_INSTRU\
    CTION_DATA\x10\x02\x12\x18\n\x14INVALID_ACCOUNT_DATA\x10\x03\x12\x1a\n\
    \x16ACCOUNT_DATA_TOO_SMALL\x10\x04\x12\x16\n\x12INSUFFICIENT_FUNDS\x10\
    \x05\x12\x18\n\x14INCORRECT_PROGRAM_ID\x10\x06\x12\x1e\n\x1aMISSING_REQU\
    IRED_SIGNATURE\x10\x07\x12\x1f\n\x1bACCOUNT_ALREADY_INITIALIZED\x10\x08\
    \x12\x19\n\x15UNINITIALIZED_ACCOUNT\x10\t\x12\x1a\n\x16UNBALANCED_INSTRU\
    CTION\x10\n\x12\x17\n\x13MODIFIED_PROGRAM_ID\x10\x0b\x12\"\n\x1eEXTERNAL\
    _ACCOUNT_LAMPORT_SPEND\x10\x0c\x12\"\n\x1eEXTERNAL_ACCOUNT_DATA_MODIFIED\
    \x10\r\x12\x1b\n\x17READONLY_LAMPORT_CHANGE\x10\x0e\x12\x1a\n\x16READONL\
    Y_DATA_MODIFIED\x10\x0f\x12\x1b\n\x17DUPLICATE_ACCOUNT_INDEX\x10\x10\x12\
    \x17\n\x13EXECUTABLE_MODIFIED\x10\x11\x12\x17\n\x13RENT_EPOCH_MODIFIED\
    \x10\x12\x12\x1b\n\x17NOT_ENOUGH_ACCOUNT_KEYS\x10\x13\x12\x1d\n\x19ACCOU\
    NT_DATA_SIZE_CHANGED\x10\x14\x12\x1a\n\x16ACCOUNT_NOT_EXECUTABLE\x10\x15\
    \x12\x19\n\x15ACCOUNT_BORROW_FAILED\x10\x16\x12\x1e\n\x1aACCOUNT_BORROW_\
    OUTSTANDING\x10\x17\x12!\n\x1dDUPLICATE_ACCOUNT_OUT_OF_SYNC\x10\x18\x12\
    \n\n\x06CUSTOM\x10\x19\x12\x11\n\rINVALID_ERROR\x10\x1a\x12\x1c\n\x18EXE\
    CUTABLE_DATA_MODIFIED\x10\x1b\x12\x1d\n\x19EXECUTABLE_LAMPORT_CHANGE\x10\
    \x1c\x12&\n\"EXECUTABLE_ACCOUNT_NOT_RENT_EXEMPT\x10\x1d\x12\x1a\n\x16UNS\
    UPPORTED_PROGRAM_ID\x10\x1e\x12\x0e\n\nCALL_DEPTH\x10\x1f\x12\x13\n\x0fM\
    ISSING_ACCOUNT\x10\x20\x12\x1a\n\x16REENTRANCY_NOT_ALLOWED\x10!\x12\x1c\
    \n\x18MAX_SEED_LENGTH_EXCEEDED\x10\"\x12\x11\n\rINVALID_SEEDS\x10#\x12\
    \x13\n\x0fINVALID_REALLOC\x10$\x12!\n\x1dCOMPUTATIONAL_BUDGET_EXCEEDED\
    \x10%\x12\x18\n\x14PRIVILEGE_ESCALATION\x10&\x12%\n!PROGRAM_ENVIRONMENT_\
    SETUP_FAILURE\x10'\x12\x1e\n\x1aPROGRAM_FAILED_TO_COMPLETE\x10(\x12\x1d\
    \n\x19PROGRAM_FAILED_TO_COMPILE\x10)\x12\r\n\tIMMUTABLE\x10*\x12\x17\n\
    \x13INCORRECT_AUTHORITY\x10+BBZ@github.com/streamingfast/sf-solana/pb/sf\
    /solana/codec/v1;pbcodecJ\x87s\n\x07\x12\x05\0\0\x8b\x03\x01\n\x08\n\x01\
    \x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\x1b\n\x08\n\x01\x08\
    \x12\x03\x04\0W\n\t\n\x02\x08\x0b\x12\x03\x04\0W\n\t\n\x02\x03\0\x12\x03\
    \x06\0#\n\n\n\x02\x04\0\x12\x04\x08\0\x19\x01\n\n\n\x03\x04\0\x01\x12\
    \x03\x08\x08\r\n3\n\x04\x04\0\x02\0\x12\x03\t\x02\x0f\"&\x20corresponds\
    \x20to\x20the\x20Slot\x20id\x20(or\x20hash)\n\n\x0c\n\x05\x04\0\x02\0\
    \x05\x12\x03\t\x02\x07\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\t\x08\n\n\x0c\
    \n\x05\x04\0\x02\0\x03\x12\x03\t\r\x0e\n<\n\x04\x04\0\x02\x01\x12\x03\n\
    ...
    \x04\0\x02\x03\x12\x03\x0c\x02\x18\"I\x20corresponds\x20to\x20the\x20pre\
    vious_blockhash,\x20might\x20skip\x20some\x20slots,\x20so\x20beware\n\n\
    \x0c\n\x05\x04\0\x02\x03\x05\x12\x03\x0c\x02\x07\n\x0c\n\x05\x04\0\x02\
    \x03\x01\x12\x03\x0c\x08\x13\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\x0c\
    \x16\x17\n\x0b\n\x04\x04\0\x02\x04\x12\x03\r\x02\x1c\n\x0c\n\x05\x04\0\
    \x02\x04\x05\x12\x03\r\x02\x08\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03\r\t\
    \x17\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03\r\x1a\x1b\n\x0b\n\x04\x04\0\
    \x02\x05\x12\x03\x0e\x02$\n\x0c\n\x05\x04\0\x02\x05\x05\x12\x03\x0e\x02\
    \x08\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03\x0e\t\x1f\n\x0c\n\x05\x04\0\
    \x02\x05\x03\x12\x03\x0e\"#\n\x0b\n\x04\x04\0\x02\x06\x12\x03\x0f\x02\"\
    \n\x0c\n\x05\x04\0\x02\x06\x05\x12\x03\x0f\x02\x08\n\x0c\n\x05\x04\0\x02\
    \x06\x01\x12\x03\x0f\t\x1d\n\x0c\n\x05\x04\0\x02\x06\x03\x12\x03\x0f\x20\
    !\n\x0b\n\x04\x04\0\x02\x07\x12\x03\x10\x02\x16\n\x0c\n\x05\x04\0\x02\
    \x07\x05\x12\x03\x10\x02\x08\n\x0c\n\x05\x04\0\x02\x07\x01\x12\x03\x10\t\
    \x11\n\x0c\n\x05\x04\0\x02\x07\x03\x12\x03\x10\x14\x15\n\x0b\n\x04\x04\0\
    \x02\x08\x12\x03\x12\x02\x1c\n\x0c\n\x05\x04\0\x02\x08\x05\x12\x03\x12\
    \x02\x07\n\x0c\n\x05\x04\0\x02\x08\x01\x12\x03\x12\x08\x17\n\x0c\n\x05\
    \x04\0\x02\x08\x03\x12\x03\x12\x1a\x1b\n\x0b\n\x04\x04\0\x02\t\x12\x03\
    \x14\x02)\n\x0c\n\x05\x04\0\x02\t\x04\x12\x03\x14\x02\n\n\x0c\n\x05\x04\
    \0\x02\t\x06\x12\x03\x14\x0b\x16\n\x0c\n\x05\x04\0\x02\t\x01\x12\x03\x14\
    \x17#\n\x0c\n\x05\x04\0\x02\t\x03\x12\x03\x14&(\n\x0b\n\x04\x04\0\x02\n\
    \x12\x03\x15\x02\x20\n\x0c\n\x05\x04\0\x02\n\x05\x12\x03\x15\x02\x08\n\
    \x0c\n\x05\x04\0\x02\n\x01\x12\x03\x15\t\x1a\n\x0c\n\x05\x04\0\x02\n\x03\
    \x12\x03\x15\x1d\x1f\n\x0b\n\x04\x04\0\x02\x0b\x12\x03\x17\x02&\n\x0c\n\
    \x05\x04\0\x02\x0b\x05\x12\x03\x17\x02\x06\n\x0c\n\x05\x04\0\x02\x0b\x01\
    \x12\x03\x17\x07\x20\n\x0c\n\x05\x04\0\x02\x0b\x03\x12\x03\x17#%\n\x0b\n\
    \x04\x04\0\x02\x0c\x12\x03\x18\x02'\n\x0c\n\x05\x04\0\x02\x0c\x05\x12\
    \x03\x18\x02\x08\n\x0c\n\x05\x04\0\x02\x0c\x01\x12\x03\x18\t!\n\x0c\n\
    \x05\x04\0\x02\x0c\x03\x12\x03\x18$&\n\n\n\x02\x04\x01\x12\x04\x1b\0\x1d\
    \x01\n\n\n\x03\x04\x01\x01\x12\x03\x1b\x08\r\n\x0b\n\x04\x04\x01\x02\0\
    \x12\x03\x1c\x02(\n\x0c\n\x05\x04\x01\x02\0\x04\x12\x03\x1c\x02\n\n\x0c\
    \n\x05\x04\x01\x02\0\x06\x12\x03\x1c\x0b\x16\n\x0c\n\x05\x04\x01\x02\0\
    \x01\x12\x03\x1c\x17#\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\x1c&'\nQ\n\
    \x02\x04\x02\x12\x04\x20\0#\x01\x1aE\x20Bundled\x20in\x20separate\x20fil\
    es,\x20referenced\x20by\x20`account_changes_file_ref`\n\n\n\n\x03\x04\
    \x02\x01\x12\x03\x20\x08\x1c\nP\n\x04\x04\x02\x02\0\x12\x03\"\x026\x1aC\
    \x20Maps\x20to\x20the\x20index\x20of\x20the\x20`repeated`\x20field\x20fo\
    r\x20Block::transactions\n\n\x0c\n\x05\x04\x02\x02\0\x04\x12\x03\"\x02\n\
    \n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03\"\x0b$\n\x0c\n\x05\x04\x02\x02\0\
    \x01\x12\x03\"%1\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03\"45\n\n\n\x02\x04\
    \x03\x12\x04%\0+\x01\n\n\n\x03\x04\x03\x01\x12\x03%\x08!\n\x0b\n\x04\x04\
    \x03\x02\0\x12\x03&\x02\x12\n\x0c\n\x05\x04\x03\x02\0\x05\x12\x03&\x02\
    \x07\n\x0c\n\x05\x04\x03\x02\0\x01\x12\x03&\x08\r\n\x0c\n\x05\x04\x03\
    \x02\0\x03\x12\x03&\x10\x11\nh\n\x04\x04\x03\x02\x01\x12\x03*\x029\x1a[\
    \x20Maps\x20to\x20the\x20index\x20within\x20the\x20`repeated`\x20field\
    \x20of\x20the\x20proto\x20for\n\x20Transaction::instructions\n\n\x0c\n\
    \x05\x04\x03\x02\x01\x04\x12\x03*\x02\n\n\x0c\n\x05\x04\x03\x02\x01\x06\
    \x12\x03*\x0b'\n\x0c\n\x05\x04\x03\x02\x01\x01\x12\x03*(4\n\x0c\n\x05\
    \x04\x03\x02\x01\x03\x12\x03*78\n\n\n\x02\x04\x04\x12\x04-\00\x01\n\n\n\
    \x03\x04\x04\x01\x12\x03-\x08$\n=\n\x04\x04\x04\x02\0\x12\x03/\x02%\x1a0\
    \x20Data\x20to\x20be\x20put\x20in\x20Instruction::account_changes\n\n\
    \x0c\n\x05\x04\x04\x02\0\x04\x12\x03/\x02\n\n\x0c\n\x05\x04\x04\x02\0\
    \x06\x12\x03/\x0b\x18\n\x0c\n\x05\x04\x04\x02\0\x01\x12\x03/\x19\x20\n\
    \x0c\n\x05\x04\x04\x02\0\x03\x12\x03/#$\n\n\n\x02\x04\x05\x12\x042\0K\
    \x01\n\n\n\x03\x04\x05\x01\x12\x032\x08\x13\n~\n\x04\x04\x05\x02\0\x12\
    \x035\x02\x0f\x1aq\x20The\x20transaction\x20ID\x20corresponds\x20to\x20t\
    he\x20_first_\n\x20signature.\x20Additional\x20signatures\x20are\x20in\
    \x20`additional_signatures`.\n\n\x0c\n\x05\x04\x05\x02\0\x05\x12\x035\
    \x02\x07\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x035\x08\n\n\x0c\n\x05\x04\
    \x05\x02\0\x03\x12\x035\r\x0e\n\xc2\x01\n\x04\x04\x05\x02\x01\x12\x03:\
    \x02\x13\x1a\xb4\x01\x20Index\x20from\x20within\x20a\x20single\x20Slot,\
    \x20deterministically\x20ordered\x20to\x20the\n\x20best\x20of\x20our\x20\
    ability\x20using\x20the\x20transaction\x20ID\x20as\x20a\x20sort\x20key\
    \x20for\n\x20the\x20batch\x20of\x20transactions\x20executed\x20in\x20par\
    allel.\n\n\x0c\n\x05\x04\x05\x02\x01\x05\x12\x03:\x02\x08\n\x0c\n\x05\
    \x04\x05\x02\x01\x01\x12\x03:\t\x0e\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\
    ...
    \x05\x02\x02\x03\x12\x03<)*\n\x0b\n\x04\x04\x05\x02\x03\x12\x03>\x02\x1b\
    \n\x0c\n\x05\x04\x05\x02\x03\x06\x12\x03>\x02\x0f\n\x0c\n\x05\x04\x05\
    \x02\x03\x01\x12\x03>\x10\x16\n\x0c\n\x05\x04\x05\x02\x03\x03\x12\x03>\
    \x19\x1a\n/\n\x04\x04\x05\x02\x04\x12\x03@\x02\"\x1a\"\x20From\x20the\
    \x20original\x20Message\x20object\n\n\x0c\n\x05\x04\x05\x02\x04\x04\x12\
    \x03@\x02\n\n\x0c\n\x05\x04\x05\x02\x04\x05\x12\x03@\x0b\x10\n\x0c\n\x05\
    \x04\x05\x02\x04\x01\x12\x03@\x11\x1d\n\x0c\n\x05\x04\x05\x02\x04\x03\
    \x12\x03@\x20!\n/\n\x04\x04\x05\x02\x05\x12\x03B\x02\x1d\x1a\"\x20From\
    \x20the\x20original\x20Message\x20object\n\n\x0c\n\x05\x04\x05\x02\x05\
    \x05\x12\x03B\x02\x07\n\x0c\n\x05\x04\x05\x02\x05\x01\x12\x03B\x08\x18\n\
    \x0c\n\x05\x04\x05\x02\x05\x03\x12\x03B\x1b\x1c\n;\n\x04\x04\x05\x02\x06\
    \x12\x03E\x02#\x1a.\x20What\x20follows\x20Once\x20executed\x20these\x20c\
    an\x20be\x20set:\n\n\x0c\n\x05\x04\x05\x02\x06\x04\x12\x03E\x02\n\n\x0c\
    \n\x05\x04\x05\x02\x06\x05\x12\x03E\x0b\x11\n\x0c\n\x05\x04\x05\x02\x06\
    \x01\x12\x03E\x12\x1e\n\x0c\n\x05\x04\x05\x02\x06\x03\x12\x03E!\"\nN\n\
    \x04\x04\x05\x02\x07\x12\x03G\x02(\x1aA\x20Instructions,\x20containing\
    \x20both\x20top-level\x20and\x20nested\x20transactions\n\n\x0c\n\x05\x04\
    \x05\x02\x07\x04\x12\x03G\x02\n\n\x0c\n\x05\x04\x05\x02\x07\x06\x12\x03G\
    \x0b\x16\n\x0c\n\x05\x04\x05\x02\x07\x01\x12\x03G\x17#\n\x0c\n\x05\x04\
    \x05\x02\x07\x03\x12\x03G&'\n\x0b\n\x04\x04\x05\x02\x08\x12\x03I\x02\x12\
    \n\x0c\n\x05\x04\x05\x02\x08\x05\x12\x03I\x02\x06\n\x0c\n\x05\x04\x05\
    \x02\x08\x01\x12\x03I\x07\r\n\x0c\n\x05\x04\x05\x02\x08\x03\x12\x03I\x10\
    \x11\n\x0b\n\x04\x04\x05\x02\t\x12\x03J\x02\x1e\n\x0c\n\x05\x04\x05\x02\
    \t\x06\x12\x03J\x02\x12\n\x0c\n\x05\x04\x05\x02\t\x01\x12\x03J\x13\x18\n\
    \x0c\n\x05\x04\x05\x02\t\x03\x12\x03J\x1b\x1d\n\n\n\x02\x04\x06\x12\x04M\
    \0Q\x01\n\n\n\x03\x04\x06\x01\x12\x03M\x08\x15\n\x0b\n\x04\x04\x06\x02\0\
    \x12\x03N\x02%\n\x0c\n\x05\x04\x06\x02\0\x05\x12\x03N\x02\x08\n\x0c\n\
    \x05\x04\x06\x02\0\x01\x12\x03N\t\x20\n\x0c\n\x05\x04\x06\x02\0\x03\x12\
    \x03N#$\n\x0b\n\x04\x04\x06\x02\x01\x12\x03O\x02*\n\x0c\n\x05\x04\x06\
    \x02\x01\x05\x12\x03O\x02\x08\n\x0c\n\x05\x04\x06\x02\x01\x01\x12\x03O\t\
    ...
    \x20(id=1,\x20parent=0)\n-\x20instr2\x20(id=2,\x20parent=0)\x20(pubkey1\
    \x20is\x20writable)\n-\x20instr3\x20(id=3,\x20parent=2)\x20(pubkey1\x20i\
    s\x20writable)\n-\x20instr4\x20(id=4,\x20parent=3)\x20(pubkey1\x20is\x20\
    writable)\n-\x20instr5\x20(id=5,\x20parent=4)\x20(pubkey1\x20is\x20writa\
    ble,\x20mutates\x20pubkey1)\ncollect\x20delta\x20of\x20pubkey1\ncollect\
    \x20delta\x20of\x20pubkey1\x20ONLY\x20IF\x20CHANGED\x20AGAIN,\x20from\
    \x20last\x20time\x20we\x20took\x20a\x20snapshot\x20of\x20it.\ncollect\
    \x20delta\x20of\x20pubkey1\n-\x20instr6\x20(id=6,\x20parent=0)\n\n\n\n\
    \x03\x04\x07\x01\x12\x03`\x08\x13\n\x0b\n\x04\x04\x07\x02\0\x12\x03a\x02\
    \x17\n\x0c\n\x05\x04\x07\x02\0\x05\x12\x03a\x02\x07\n\x0c\n\x05\x04\x07\
    \x02\0\x01\x12\x03a\x08\x12\n\x0c\n\x05\x04\x07\x02\0\x03\x12\x03a\x15\
    \x16\n\x0b\n\x04\x04\x07\x02\x01\x12\x03b\x02\"\n\x0c\n\x05\x04\x07\x02\
    \x01\x04\x12\x03b\x02\n\n\x0c\n\x05\x04\x07\x02\x01\x05\x12\x03b\x0b\x10\
    \n\x0c\n\x05\x04\x07\x02\x01\x01\x12\x03b\x11\x1d\n\x0c\n\x05\x04\x07\
    \x02\x01\x03\x12\x03b\x20!\n\x0b\n\x04\x04\x07\x02\x02\x12\x03c\x02\x11\
    \n\x0c\n\x05\x04\x07\x02\x02\x05\x12\x03c\x02\x07\n\x0c\n\x05\x04\x07\
    \x02\x02\x01\x12\x03c\x08\x0c\n\x0c\n\x05\x04\x07\x02\x02\x03\x12\x03c\
    \x0f\x10\na\n\x04\x04\x07\x02\x03\x12\x03g\x02\x152T\x20What\x20follows\
    \x20is\x20execution\x20trace\x20data,\x20could\x20be\x20empty\x20for\x20\
    un-executed\x20transactions.\n\n\x0c\n\x05\x04\x07\x02\x03\x05\x12\x03g\
    \x02\x08\n\x0c\n\x05\x04\x07\x02\x03\x01\x12\x03g\t\x10\n\x0c\n\x05\x04\
    \x07\x02\x03\x03\x12\x03g\x13\x14\n\x0b\n\x04\x04\x07\x02\x04\x12\x03h\
    \x02\x1c\n\x0c\n\x05\x04\x07\x02\x04\x05\x12\x03h\x02\x08\n\x0c\n\x05\
    \x04\x07\x02\x04\x01\x12\x03h\t\x17\n\x0c\n\x05\x04\x07\x02\x04\x03\x12\
    \x03h\x1a\x1b\n\x0b\n\x04\x04\x07\x02\x05\x12\x03i\x02\x13\n\x0c\n\x05\
    \x04\x07\x02\x05\x05\x12\x03i\x02\x08\n\x0c\n\x05\x04\x07\x02\x05\x01\
    \x12\x03i\t\x0e\n\x0c\n\x05\x04\x07\x02\x05\x03\x12\x03i\x11\x12\n\x0b\n\
    \x04\x04\x07\x02\x06\x12\x03k\x02-\n\x0c\n\x05\x04\x07\x02\x06\x04\x12\
    \x03k\x02\n\n\x0c\n\x05\x04\x07\x02\x06\x06\x12\x03k\x0b\x18\n\x0c\n\x05\
    \x04\x07\x02\x06\x01\x12\x03k\x19(\n\x0c\n\x05\x04\x07\x02\x06\x03\x12\
    \x03k+,\n\x0b\n\x04\x04\x07\x02\x07\x12\x03l\x02.\n\x0c\n\x05\x04\x07\
    \x02\x07\x04\x12\x03l\x02\n\n\x0c\n\x05\x04\x07\x02\x07\x06\x12\x03l\x0b\
    \x18\n\x0c\n\x05\x04\x07\x02\x07\x01\x12\x03l\x19(\n\x0c\n\x05\x04\x07\
    \x02\x07\x03\x12\x03l+-\n\x0b\n\x04\x04\x07\x02\x08\x12\x03n\x02\x13\n\
    \x0c\n\x05\x04\x07\x02\x08\x05\x12\x03n\x02\x06\n\x0c\n\x05\x04\x07\x02\
    \x08\x01\x12\x03n\x07\r\n\x0c\n\x05\x04\x07\x02\x08\x03\x12\x03n\x10\x12\
    \n\x0b\n\x04\x04\x07\x02\t\x12\x03o\x02\x1e\n\x0c\n\x05\x04\x07\x02\t\
    \x06\x12\x03o\x02\x12\n\x0c\n\x05\x04\x07\x02\t\x01\x12\x03o\x13\x18\n\
    \x0c\n\x05\x04\x07\x02\t\x03\x12\x03o\x1b\x1d\n\n\n\x02\x04\x08\x12\x04r\
    \0v\x01\n\n\n\x03\x04\x08\x01\x12\x03r\x08\x15\n\x0b\n\x04\x04\x08\x02\0\
    \x12\x03s\x02\x13\n\x0c\n\x05\x04\x08\x02\0\x05\x12\x03s\x02\x07\n\x0c\n\
    \x05\x04\x08\x02\0\x01\x12\x03s\x08\x0e\n\x0c\n\x05\x04\x08\x02\0\x03\
    \x12\x03s\x11\x12\n\x0b\n\x04\x04\x08\x02\x01\x12\x03t\x02\x1b\n\x0c\n\
    \x05\x04\x08\x02\x01\x05\x12\x03t\x02\x08\n\x0c\n\x05\x04\x08\x02\x01\
    \x01\x12\x03t\t\x16\n\x0c\n\x05\x04\x08\x02\x01\x03\x12\x03t\x19\x1a\n\
    \x0b\n\x04\x04\x08\x02\x02\x12\x03u\x02\x1a\n\x0c\n\x05\x04\x08\x02\x02\
    \x05\x12\x03u\x02\x08\n\x0c\n\x05\x04\x08\x02\x02\x01\x12\x03u\t\x15\n\
    \x0c\n\x05\x04\x08\x02\x02\x03\x12\x03u\x18\x19\n\n\n\x02\x04\t\x12\x04x\
    \0}\x01\n\n\n\x03\x04\t\x01\x12\x03x\x08\x15\n\x0b\n\x04\x04\t\x02\0\x12\
    \x03y\x02\x13\n\x0c\n\x05\x04\t\x02\0\x05\x12\x03y\x02\x07\n\x0c\n\x05\
    \x04\t\x02\0\x01\x12\x03y\x08\x0e\n\x0c\n\x05\x04\t\x02\0\x03\x12\x03y\
    \x11\x12\n\x0b\n\x04\x04\t\x02\x01\x12\x03z\x02\x16\n\x0c\n\x05\x04\t\
    \x02\x01\x05\x12\x03z\x02\x07\n\x0c\n\x05\x04\t\x02\x01\x01\x12\x03z\x08\
    \x11\n\x0c\n\x05\x04\t\x02\x01\x03\x12\x03z\x14\x15\n\x0b\n\x04\x04\t\
    \x02\x02\x12\x03{\x02\x15\n\x0c\n\x05\x04\t\x02\x02\x05\x12\x03{\x02\x07\
    ...
    \x08\x18\n\x0c\n\x04\x04\n\x02\0\x12\x04\x80\x01\x02\x20\n\r\n\x05\x04\n\
    \x02\0\x06\x12\x04\x80\x01\x02\x16\n\r\n\x05\x04\n\x02\0\x01\x12\x04\x80\
    \x01\x17\x1b\n\r\n\x05\x04\n\x02\0\x03\x12\x04\x80\x01\x1e\x1f\n\x0c\n\
    \x04\x04\n\x02\x01\x12\x04\x81\x01\x02\"\n\r\n\x05\x04\n\x02\x01\x06\x12\
    \x04\x81\x01\x02\x15\n\r\n\x05\x04\n\x02\x01\x01\x12\x04\x81\x01\x16\x1d\
    \n\r\n\x05\x04\n\x02\x01\x03\x12\x04\x81\x01\x20!\n\x0c\n\x02\x04\x0b\
    \x12\x06\x84\x01\0\x87\x01\x01\n\x0b\n\x03\x04\x0b\x01\x12\x04\x84\x01\
    \x08#\n\x0c\n\x04\x04\x0b\x02\0\x12\x04\x85\x01\x02\x13\n\r\n\x05\x04\
    \x0b\x02\0\x05\x12\x04\x85\x01\x02\x08\n\r\n\x05\x04\x0b\x02\0\x01\x12\
    \x04\x85\x01\t\x0e\n\r\n\x05\x04\x0b\x02\0\x03\x12\x04\x85\x01\x11\x12\n\
    \x0c\n\x04\x04\x0b\x02\x01\x12\x04\x86\x01\x02\x1d\n\r\n\x05\x04\x0b\x02\
    \x01\x06\x12\x04\x86\x01\x02\x12\n\r\n\x05\x04\x0b\x02\x01\x01\x12\x04\
    \x86\x01\x13\x18\n\r\n\x05\x04\x0b\x02\x01\x03\x12\x04\x86\x01\x1b\x1c\n\
    \x0c\n\x02\x05\0\x12\x06\x89\x01\0\xd0\x01\x01\n\x0b\n\x03\x05\0\x01\x12\
    \x04\x89\x01\x05\x19\n\x8b\x01\n\x04\x05\0\x02\0\x12\x04\x8d\x01\x02\x15\
    \x1a}/\x20An\x20account\x20is\x20already\x20being\x20processed\x20in\x20\
    another\x20transaction\x20in\x20a\x20way\n/\x20that\x20does\x20not\x20su\
    pport\x20parallelism\n\x20Account\x20in\x20use\"\n\n\r\n\x05\x05\0\x02\0\
    \x01\x12\x04\x8d\x01\x02\x10\n\r\n\x05\x05\0\x02\0\x02\x12\x04\x8d\x01\
    \x13\x14\n\xd8\x01\n\x04\x05\0\x02\x01\x12\x04\x92\x01\x02\x1b\x1a\xc9\
    \x01/\x20A\x20`Pubkey`\x20appears\x20twice\x20in\x20the\x20transaction's\
    \x20`account_keys`.\x20\x20Instructions\x20can\x20reference\n/\x20`Pubke\
    y`s\x20more\x20than\x20once\x20but\x20the\x20message\x20must\x20contain\
    \x20a\x20list\x20with\x20no\x20duplicate\x20keys\n\x20Account\x20loaded\
    \x20twice\"\n\n\r\n\x05\x05\0\x02\x01\x01\x12\x04\x92\x01\x02\x16\n\r\n\
    \x05\x05\0\x02\x01\x02\x12\x04\x92\x01\x19\x1a\n\x99\x01\n\x04\x05\0\x02\
    \x02\x12\x04\x96\x01\x02\x18\x1a\x8a\x01/\x20Attempt\x20to\x20debit\x20a\
    n\x20account\x20but\x20found\x20no\x20record\x20of\x20a\x20prior\x20cred\
    it.\n\x20Attempt\x20to\x20debit\x20an\x20account\x20but\x20found\x20no\
    \x20record\x20of\x20a\x20prior\x20credit.\"\n\n\r\n\x05\x05\0\x02\x02\
    \x01\x12\x04\x96\x01\x02\x13\n\r\n\x05\x05\0\x02\x02\x02\x12\x04\x96\x01\
    \x16\x17\nn\n\x04\x05\0\x02\x03\x12\x04\x9a\x01\x02\x20\x1a`/\x20Attempt\
    \x20to\x20load\x20a\x20program\x20that\x20does\x20not\x20exist\n\x20Atte\
    mpt\x20to\x20load\x20a\x20program\x20that\x20does\x20not\x20exist\"\n\n\
    \r\n\x05\x05\0\x02\x03\x01\x12\x04\x9a\x01\x02\x1b\n\r\n\x05\x05\0\x02\
    \x03\x02\x12\x04\x9a\x01\x1e\x1f\n\x8b\x01\n\x04\x05\0\x02\x04\x12\x04\
    \x9e\x01\x02!\x1a}/\x20The\x20from\x20`Pubkey`\x20does\x20not\x20have\
    \x20sufficient\x20balance\x20to\x20pay\x20the\x20fee\x20to\x20schedule\
    \x20the\x20transaction\n\x20Insufficient\x20funds\x20for\x20fee\"\n\n\r\
    \n\x05\x05\0\x02\x04\x01\x12\x04\x9e\x01\x02\x1c\n\r\n\x05\x05\0\x02\x04\
    \x02\x12\x04\x9e\x01\x1f\x20\n|\n\x04\x05\0\x02\x05\x12\x04\xa2\x01\x02\
    \x1e\x1an/\x20This\x20account\x20may\x20not\x20be\x20used\x20to\x20pay\
    \x20transaction\x20fees\n\x20This\x20account\x20may\x20not\x20be\x20used\
    \x20to\x20pay\x20transaction\x20fees\"\n\n\r\n\x05\x05\0\x02\x05\x01\x12\
    \x04\xa2\x01\x02\x19\n\r\n\x05\x05\0\x02\x05\x02\x12\x04\xa2\x01\x1c\x1d\
    \n\x91\x02\n\x04\x05\0\x02\x06\x12\x04\xa8\x01\x02\x1a\x1a\x82\x02/\x20T\
    he\x20bank\x20has\x20seen\x20this\x20`Signature`\x20before.\x20This\x20c\
    an\x20occur\x20under\x20normal\x20operation\n/\x20when\x20a\x20UDP\x20pa\
    cket\x20is\x20duplicated,\x20as\x20a\x20user\x20error\x20from\x20a\x20cl\
    ient\x20not\x20updating\n/\x20its\x20`recent_blockhash`,\x20or\x20as\x20\
    a\x20double-spend\x20attack.\n\x20The\x20bank\x20has\x20seen\x20this\x20\
    signature\x20before\"\n\n\r\n\x05\x05\0\x02\x06\x01\x12\x04\xa8\x01\x02\
    \x15\n\r\n\x05\x05\0\x02\x06\x02\x12\x04\xa8\x01\x18\x19\n\xa9\x01\n\x04\
    \x05\0\x02\x07\x12\x04\xad\x01\x02\x1a\x1a\x9a\x01/\x20The\x20bank\x20ha\
    s\x20not\x20seen\x20the\x20given\x20`recent_blockhash`\x20or\x20the\x20t\
    ransaction\x20is\x20too\x20old\x20and\n/\x20the\x20`recent_blockhash`\
    \x20has\x20been\x20discarded.\n\x20Blockhash\x20not\x20found\"\n\n\r\n\
    \x05\x05\0\x02\x07\x01\x12\x04\xad\x01\x02\x15\n\r\n\x05\x05\0\x02\x07\
    \x02\x12\x04\xad\x01\x18\x19\n\xca\x01\n\x04\x05\0\x02\x08\x12\x04\xb2\
    \x01\x02\x18\x1a\xbb\x01/\x20An\x20error\x20occurred\x20while\x20process\
    ing\x20an\x20instruction.\x20The\x20first\x20element\x20of\x20the\x20tup\
    le\n/\x20indicates\x20the\x20instruction\x20index\x20in\x20which\x20the\
    \x20error\x20occurred.\n\x20Error\x20processing\x20Instruction\x20{0}:\
    \x20{1}\"\n\n\r\n\x05\x05\0\x02\x08\x01\x12\x04\xb2\x01\x02\x13\n\r\n\
    \x05\x05\0\x02\x08\x02\x12\x04\xb2\x01\x16\x17\nN\n\x04\x05\0\x02\t\x12\
    \x04\xb6\x01\x02\x1a\x1a@/\x20Loader\x20call\x20chain\x20is\x20too\x20de\
    ep\n\x20Loader\x20call\x20chain\x20is\x20too\x20deep\"\n\n\r\n\x05\x05\0\
    \x02\t\x01\x12\x04\xb6\x01\x02\x15\n\r\n\x05\x05\0\x02\t\x02\x12\x04\xb6\
    \x01\x18\x19\n\x82\x01\n\x04\x05\0\x02\n\x12\x04\xba\x01\x02!\x1at/\x20T\
    ransaction\x20requires\x20a\x20fee\x20but\x20has\x20no\x20signature\x20p\
    resent\n\x20Transaction\x20requires\x20a\x20fee\x20but\x20has\x20no\x20s\
    ignature\x20present\"\n\n\r\n\x05\x05\0\x02\n\x01\x12\x04\xba\x01\x02\
    \x1b\n\r\n\x05\x05\0\x02\n\x02\x12\x04\xba\x01\x1e\x20\nv\n\x04\x05\0\
    \x02\x0b\x12\x04\xbe\x01\x02\x1d\x1ah/\x20Transaction\x20contains\x20an\
    \x20invalid\x20account\x20reference\n\x20Transaction\x20contains\x20an\
    \x20invalid\x20account\x20reference\"\n\n\r\n\x05\x05\0\x02\x0b\x01\x12\
    \x04\xbe\x01\x02\x17\n\r\n\x05\x05\0\x02\x0b\x02\x12\x04\xbe\x01\x1a\x1c\
    \nr\n\x04\x05\0\x02\x0c\x12\x04\xc2\x01\x02\x19\x1ad/\x20Transaction\x20\
    did\x20not\x20pass\x20signature\x20verification\n\x20Transaction\x20did\
    \x20not\x20pass\x20signature\x20verification\"\n\n\r\n\x05\x05\0\x02\x0c\
    \x01\x12\x04\xc2\x01\x02\x13\n\r\n\x05\x05\0\x02\x0c\x02\x12\x04\xc2\x01\
    \x16\x18\n\x82\x01\n\x04\x05\0\x02\r\x12\x04\xc6\x01\x02%\x1at/\x20This\
    \x20program\x20may\x20not\x20be\x20used\x20for\x20executing\x20instructi\
    ons\n\x20This\x20program\x20may\x20not\x20be\x20used\x20for\x20executing\
    \x20instructions\"\n\n\r\n\x05\x05\0\x02\r\x01\x12\x04\xc6\x01\x02\x1f\n\
    \r\n\x05\x05\0\x02\r\x02\x12\x04\xc6\x01\"$\n\xdd\x01\n\x04\x05\0\x02\
    \x0e\x12\x04\xcc\x01\x02\x18\x1a\xce\x01/\x20Transaction\x20failed\x20to\
    \x20sanitize\x20accounts\x20offsets\x20correctly\n/\x20implies\x20that\
    \x20account\x20locks\x20are\x20not\x20taken\x20for\x20this\x20TX,\x20and\
    \x20should\n/\x20not\x20be\x20unlocked.\n\x20Transaction\x20failed\x20to\
    \x20sanitize\x20accounts\x20offsets\x20correctly\"\n\n\r\n\x05\x05\0\x02\
    \x0e\x01\x12\x04\xcc\x01\x02\x12\n\r\n\x05\x05\0\x02\x0e\x02\x12\x04\xcc\
    \x01\x15\x17\nO\n\x04\x05\0\x02\x0f\x12\x04\xcf\x01\x02\x1b\x1aA\x20Tran\
    sactions\x20are\x20currently\x20disabled\x20due\x20to\x20cluster\x20main\
    tenance\"\n\n\r\n\x05\x05\0\x02\x0f\x01\x12\x04\xcf\x01\x02\x15\n\r\n\
    \x05\x05\0\x02\x0f\x02\x12\x04\xcf\x01\x18\x1a\n\x0c\n\x02\x04\x0c\x12\
    \x06\xd2\x01\0\xd5\x01\x01\n\x0b\n\x03\x04\x0c\x01\x12\x04\xd2\x01\x08\
    \x18\n\x0c\n\x04\x04\x0c\x02\0\x12\x04\xd3\x01\x02\x20\n\r\n\x05\x04\x0c\
    \x02\0\x06\x12\x04\xd3\x01\x02\x16\n\r\n\x05\x04\x0c\x02\0\x01\x12\x04\
    \xd3\x01\x17\x1b\n\r\n\x05\x04\x0c\x02\0\x03\x12\x04\xd3\x01\x1e\x1f\n\
    \x0c\n\x04\x04\x0c\x02\x01\x12\x04\xd4\x01\x02\"\n\r\n\x05\x04\x0c\x02\
    \x01\x06\x12\x04\xd4\x01\x02\x15\n\r\n\x05\x04\x0c\x02\x01\x01\x12\x04\
    \xd4\x01\x16\x1d\n\r\n\x05\x04\x0c\x02\x01\x03\x12\x04\xd4\x01\x20!\n\
    \x0c\n\x02\x04\r\x12\x06\xd7\x01\0\xd9\x01\x01\n\x0b\n\x03\x04\r\x01\x12\
    \x04\xd7\x01\x08\x1e\n\x0c\n\x04\x04\r\x02\0\x12\x04\xd8\x01\x02\x10\n\r\
    \n\x05\x04\r\x02\0\x05\x12\x04\xd8\x01\x02\x08\n\r\n\x05\x04\r\x02\0\x01\
    \x12\x04\xd8\x01\t\x0b\n\r\n\x05\x04\r\x02\0\x03\x12\x04\xd8\x01\x0e\x0f\
    \n\x0c\n\x02\x05\x01\x12\x06\xdb\x01\0\x8b\x03\x01\n\x0b\n\x03\x05\x01\
    \x01\x12\x04\xdb\x01\x05\x19\nz\n\x04\x05\x01\x02\0\x12\x04\xde\x01\x02\
    \x14\x1al/\x20Deprecated!\x20Use\x20CustomError\x20instead!\x20The\x20pr\
    ogram\x20instruction\x20returned\x20an\x20error\n\x20generic\x20instruct\
    ion\x20error\n\n\r\n\x05\x05\x01\x02\0\x01\x12\x04\xde\x01\x02\x0f\n\r\n\
    \x05\x05\x01\x02\0\x02\x12\x04\xde\x01\x12\x13\n[\n\x04\x05\x01\x02\x01\
    \x12\x04\xe1\x01\x02\x17\x1aM/\x20The\x20arguments\x20provided\x20to\x20\
    a\x20program\x20were\x20invalid\n\x20invalid\x20program\x20argument\n\n\
    \r\n\x05\x05\x01\x02\x01\x01\x12\x04\xe1\x01\x02\x12\n\r\n\x05\x05\x01\
    \x02\x01\x02\x12\x04\xe1\x01\x15\x16\nV\n\x04\x05\x01\x02\x02\x12\x04\
    \xe5\x01\x02\x1f\x1aH/\x20An\x20instruction's\x20data\x20contents\x20wer\
    e\x20invalid\n\x20invalid\x20instruction\x20data\n\n\r\n\x05\x05\x01\x02\
    \x02\x01\x12\x04\xe5\x01\x02\x1a\n\r\n\x05\x05\x01\x02\x02\x02\x12\x04\
    \xe5\x01\x1d\x1e\n]\n\x04\x05\x01\x02\x03\x12\x04\xe9\x01\x02\x1b\x1aO/\
    \x20An\x20account's\x20data\x20contents\x20was\x20invalid\n\x20invalid\
    \x20account\x20data\x20for\x20instruction\n\n\r\n\x05\x05\x01\x02\x03\
    \x01\x12\x04\xe9\x01\x02\x16\n\r\n\x05\x05\x01\x02\x03\x02\x12\x04\xe9\
    \x01\x19\x1a\nX\n\x04\x05\x01\x02\x04\x12\x04\xed\x01\x02\x1d\x1aJ/\x20A\
    n\x20account's\x20data\x20was\x20too\x20small\n\x20account\x20data\x20to\
    o\x20small\x20for\x20instruction\n\n\r\n\x05\x05\x01\x02\x04\x01\x12\x04\
    \xed\x01\x02\x18\n\r\n\x05\x05\x01\x02\x04\x02\x12\x04\xed\x01\x1b\x1c\n\
    s\n\x04\x05\x01\x02\x05\x12\x04\xf1\x01\x02\x19\x1ae/\x20An\x20account's\
    \x20balance\x20was\x20too\x20small\x20to\x20complete\x20the\x20instructi\
    on\n\x20insufficient\x20funds\x20for\x20instruction\n\n\r\n\x05\x05\x01\
    \x02\x05\x01\x12\x04\xf1\x01\x02\x14\n\r\n\x05\x05\x01\x02\x05\x02\x12\
    \x04\xf1\x01\x17\x18\ng\n\x04\x05\x01\x02\x06\x12\x04\xf5\x01\x02\x1b\
    \x1aY/\x20The\x20account\x20did\x20not\x20have\x20the\x20expected\x20pro\
    gram\x20id\n\x20incorrect\x20program\x20id\x20for\x20instruction\n\n\r\n\
    \x05\x05\x01\x02\x06\x01\x12\x04\xf5\x01\x02\x16\n\r\n\x05\x05\x01\x02\
    \x06\x02\x12\x04\xf5\x01\x19\x1a\nc\n\x04\x05\x01\x02\x07\x12\x04\xf9\
    \x01\x02!\x1aU/\x20A\x20signature\x20was\x20required\x20but\x20not\x20fo\
    und\n\x20missing\x20required\x20signature\x20for\x20instruction\n\n\r\n\
    \x05\x05\x01\x02\x07\x01\x12\x04\xf9\x01\x02\x1c\n\r\n\x05\x05\x01\x02\
    \x07\x02\x12\x04\xf9\x01\x1f\x20\n\x94\x01\n\x04\x05\x01\x02\x08\x12\x04\
    \xfd\x01\x02\"\x1a\x85\x01/\x20An\x20initialize\x20instruction\x20was\
    \x20sent\x20to\x20an\x20account\x20that\x20has\x20already\x20been\x20ini\
    tialized.\n\x20instruction\x20requires\x20an\x20uninitialized\x20account\
    \n\n\r\n\x05\x05\x01\x02\x08\x01\x12\x04\xfd\x01\x02\x1d\n\r\n\x05\x05\
    \x01\x02\x08\x02\x12\x04\xfd\x01\x20!\n\x7f\n\x04\x05\x01\x02\t\x12\x04\
    \x81\x02\x02\x1c\x1aq/\x20An\x20attempt\x20to\x20operate\x20on\x20an\x20\
    account\x20that\x20hasn't\x20been\x20initialized.\n\x20instruction\x20re\
    quires\x20an\x20initialized\x20account\n\n\r\n\x05\x05\x01\x02\t\x01\x12\
    \x04\x81\x02\x02\x17\n\r\n\x05\x05\x01\x02\t\x02\x12\x04\x81\x02\x1a\x1b\
    \n\xab\x01\n\x04\x05\x01\x02\n\x12\x04\x85\x02\x02\x1e\x1a\x9c\x01/\x20P\
    rogram's\x20instruction\x20lamport\x20balance\x20does\x20not\x20equal\
    \x20the\x20balance\x20after\x20the\x20instruction\n\x20sum\x20of\x20acco\
    unt\x20balances\x20before\x20and\x20after\x20instruction\x20do\x20not\
    \x20match\n\n\r\n\x05\x05\x01\x02\n\x01\x12\x04\x85\x02\x02\x18\n\r\n\
    \x05\x05\x01\x02\n\x02\x12\x04\x85\x02\x1b\x1d\nl\n\x04\x05\x01\x02\x0b\
    \x12\x04\x89\x02\x02\x1b\x1a^/\x20Program\x20modified\x20an\x20account's\
    \x20program\x20id\n\x20instruction\x20modified\x20the\x20program\x20id\
    \x20of\x20an\x20account\n\n\r\n\x05\x05\x01\x02\x0b\x01\x12\x04\x89\x02\
    \x02\x15\n\r\n\x05\x05\x01\x02\x0b\x02\x12\x04\x89\x02\x18\x1a\n\x96\x01\
    \n\x04\x05\x01\x02\x0c\x12\x04\x8d\x02\x02&\x1a\x87\x01/\x20Program\x20s\
    pent\x20the\x20lamports\x20of\x20an\x20account\x20that\x20doesn't\x20bel\
    ong\x20to\x20it\n\x20instruction\x20spent\x20from\x20the\x20balance\x20o\
    f\x20an\x20account\x20it\x20does\x20not\x20own\n\n\r\n\x05\x05\x01\x02\
    \x0c\x01\x12\x04\x8d\x02\x02\x20\n\r\n\x05\x05\x01\x02\x0c\x02\x12\x04\
    \x8d\x02#%\n\x8b\x01\n\x04\x05\x01\x02\r\x12\x04\x91\x02\x02&\x1a}/\x20P\
    rogram\x20modified\x20the\x20data\x20of\x20an\x20account\x20that\x20does\
    n't\x20belong\x20to\x20it\n\x20instruction\x20modified\x20data\x20of\x20\
    an\x20account\x20it\x20does\x20not\x20own\n\n\r\n\x05\x05\x01\x02\r\x01\
    \x12\x04\x91\x02\x02\x20\n\r\n\x05\x05\x01\x02\r\x02\x12\x04\x91\x02#%\n\
    n\n\x04\x05\x01\x02\x0e\x12\x04\x95\x02\x02\x1f\x1a`/\x20Read-only\x20ac\
    count's\x20lamports\x20modified\n\x20instruction\x20changed\x20the\x20ba\
    lance\x20of\x20a\x20read-only\x20account\n\n\r\n\x05\x05\x01\x02\x0e\x01\
    \x12\x04\x95\x02\x02\x19\n\r\n\x05\x05\x01\x02\x0e\x02\x12\x04\x95\x02\
    \x1c\x1e\nh\n\x04\x05\x01\x02\x0f\x12\x04\x99\x02\x02\x1e\x1aZ/\x20Read-\
    only\x20account's\x20data\x20was\x20modified\n\x20instruction\x20modifie\
    d\x20data\x20of\x20a\x20read-only\x20account\n\n\r\n\x05\x05\x01\x02\x0f\
    \x01\x12\x04\x99\x02\x02\x18\n\r\n\x05\x05\x01\x02\x0f\x02\x12\x04\x99\
    \x02\x1b\x1d\n\xb8\x01\n\x04\x05\x01\x02\x10\x12\x04\x9e\x02\x02\x1f\x1a\
    ...
    \x9e\x02\x02\x19\n\r\n\x05\x05\x01\x02\x10\x02\x12\x04\x9e\x02\x1c\x1e\n\
    x\n\x04\x05\x01\x02\x11\x12\x04\xa2\x02\x02\x1b\x1aj/\x20Executable\x20b\
    it\x20on\x20account\x20changed,\x20but\x20shouldn't\x20have\n\x20instruc\
    tion\x20changed\x20executable\x20bit\x20of\x20an\x20account\n\n\r\n\x05\
    \x05\x01\x02\x11\x01\x12\x04\xa2\x02\x02\x15\n\r\n\x05\x05\x01\x02\x11\
    \x02\x12\x04\xa2\x02\x18\x1a\nn\n\x04\x05\x01\x02\x12\x12\x04\xa6\x02\
    ...
    count\n\n\r\n\x05\x05\x01\x02\x12\x01\x12\x04\xa6\x02\x02\x15\n\r\n\x05\
    \x05\x01\x02\x12\x02\x12\x04\xa6\x02\x18\x1a\nl\n\x04\x05\x01\x02\x13\
    \x12\x04\xaa\x02\x02\x1f\x1a^/\x20The\x20instruction\x20expected\x20addi\
    tional\x20account\x20keys\n\x20insufficient\x20account\x20keys\x20for\
    \x20instruction\n\n\r\n\x05\x05\x01\x02\x13\x01\x12\x04\xaa\x02\x02\x19\
    \n\r\n\x05\x05\x01\x02\x13\x02\x12\x04\xaa\x02\x1c\x1e\nw\n\x04\x05\x01\
    \x02\x14\x12\x04\xae\x02\x02!\x1ai/\x20A\x20non-system\x20program\x20cha\
    nged\x20the\x20size\x20of\x20the\x20account\x20data\n\x20non-system\x20i\
    nstruction\x20changed\x20account\x20size\n\n\r\n\x05\x05\x01\x02\x14\x01\
    \x12\x04\xae\x02\x02\x1b\n\r\n\x05\x05\x01\x02\x14\x02\x12\x04\xae\x02\
    \x1e\x20\nk\n\x04\x05\x01\x02\x15\x12\x04\xb2\x02\x02\x1e\x1a]/\x20The\
    \x20instruction\x20expected\x20an\x20executable\x20account\n\x20instruct\
    ion\x20expected\x20an\x20executable\x20account\n\n\r\n\x05\x05\x01\x02\
    \x15\x01\x12\x04\xb2\x02\x02\x18\n\r\n\x05\x05\x01\x02\x15\x02\x12\x04\
    \xb2\x02\x1b\x1d\n\xa0\x01\n\x04\x05\x01\x02\x16\x12\x04\xb6\x02\x02\x1d\
    ...
    orrowed\n\n\r\n\x05\x05\x01\x02\x16\x01\x12\x04\xb6\x02\x02\x17\n\r\n\
    \x05\x05\x01\x02\x16\x02\x12\x04\xb6\x02\x1a\x1c\n\x98\x01\n\x04\x05\x01\
    \x02\x17\x12\x04\xba\x02\x02\"\x1a\x89\x01/\x20Account\x20data\x20has\
    ...
    eference\x20borrowed\n\n\r\n\x05\x05\x01\x02\x17\x01\x12\x04\xba\x02\x02\
    \x1c\n\r\n\x05\x05\x01\x02\x17\x02\x12\x04\xba\x02\x1f!\n\xe3\x02\n\x04\
    \x05\x01\x02\x18\x12\x04\xc0\x02\x02%\x1a\xd4\x02/\x20The\x20same\x20acc\
    ...
    \x02\x18\x01\x12\x04\xc0\x02\x02\x1f\n\r\n\x05\x05\x01\x02\x18\x02\x12\
    \x04\xc0\x02\"$\n\x83\x02\n\x04\x05\x01\x02\x19\x12\x04\xc6\x02\x02\x0e\
    ...
    rror:\x20{0:#x}\n\n\r\n\x05\x05\x01\x02\x19\x01\x12\x04\xc6\x02\x02\x08\
    \n\r\n\x05\x05\x01\x02\x19\x02\x12\x04\xc6\x02\x0b\r\n\xcc\x01\n\x04\x05\
    \x01\x02\x1a\x12\x04\xcb\x02\x02\x15\x1a\xbd\x01/\x20The\x20return\x20va\
    ...
    \x05\x05\x01\x02\x1d\x01\x12\x04\xd7\x02\x02$\n\r\n\x05\x05\x01\x02\x1d\
    \x02\x12\x04\xd7\x02')\n?\n\x04\x05\x01\x02\x1e\x12\x04\xdb\x02\x02\x1e\
    \x1a1/\x20Unsupported\x20program\x20id\n\x20Unsupported\x20program\x20id\
    \n\n\r\n\x05\x05\x01\x02\x1e\x01\x12\x04\xdb\x02\x02\x18\n\r\n\x05\x05\
    \x01\x02\x1e\x02\x12\x04\xdb\x02\x1b\x1d\nk\n\x04\x05\x01\x02\x1f\x12\
    \x04\xdf\x02\x02\x12\x1a]/\x20Cross-program\x20invocation\x20call\x20dep\
    th\x20too\x20deep\n\x20Cross-program\x20invocation\x20call\x20depth\x20t\
    oo\x20deep\n\n\r\n\x05\x05\x01\x02\x1f\x01\x12\x04\xdf\x02\x02\x0c\n\r\n\
    \x05\x05\x01\x02\x1f\x02\x12\x04\xdf\x02\x0f\x11\nu\n\x04\x05\x01\x02\
    \x20\x12\x04\xe3\x02\x02\x17\x1ag/\x20An\x20account\x20required\x20by\
    \x20the\x20instruction\x20is\x20missing\n\x20An\x20account\x20required\
    \x20by\x20the\x20instruction\x20is\x20missing\n\n\r\n\x05\x05\x01\x02\
    \x20\x01\x12\x04\xe3\x02\x02\x11\n\r\n\x05\x05\x01\x02\x20\x02\x12\x04\
    \xe3\x02\x14\x16\n\x9c\x01\n\x04\x05\x01\x02!\x12\x04\xe7\x02\x02\x1e\
    ...
    \x05\x01\x02!\x01\x12\x04\xe7\x02\x02\x18\n\r\n\x05\x05\x01\x02!\x02\x12\
    \x04\xe7\x02\x1b\x1d\n}\n\x04\x05\x01\x02\"\x12\x04\xeb\x02\x02\x20\x1ao\
    ...
    \x02\x02\x1a\n\r\n\x05\x05\x01\x02\"\x02\x12\x04\xeb\x02\x1d\x1f\nq\n\
    \x04\x05\x01\x02#\x12\x04\xef\x02\x02\x15\x1ac/\x20Provided\x20seeds\x20\
    do\x20not\x20result\x20in\x20a\x20valid\x20address\n\x20Provided\x20seed\
    s\x20do\x20not\x20result\x20in\x20a\x20valid\x20address\n\n\r\n\x05\x05\
    \x01\x02#\x01\x12\x04\xef\x02\x02\x0f\n\r\n\x05\x05\x01\x02#\x02\x12\x04\
    \xef\x02\x12\x14\nd\n\x04\x05\x01\x02$\x12\x04\xf3\x02\x02\x17\x1aV/\x20\
    Failed\x20to\x20reallocate\x20account\x20data\x20of\x20this\x20length\n\
    \x20Failed\x20to\x20reallocate\x20account\x20data\n\n\r\n\x05\x05\x01\
    \x02$\x01\x12\x04\xf3\x02\x02\x11\n\r\n\x05\x05\x01\x02$\x02\x12\x04\xf3\
    \x02\x14\x16\nM\n\x04\x05\x01\x02%\x12\x04\xf7\x02\x02%\x1a?/\x20Computa\
    tional\x20budget\x20exceeded\n\x20Computational\x20budget\x20exceeded\n\
    \n\r\n\x05\x05\x01\x02%\x01\x12\x04\xf7\x02\x02\x1f\n\r\n\x05\x05\x01\
    \x02%\x02\x12\x04\xf7\x02\"$\n\x9e\x01\n\x04\x05\x01\x02&\x12\x04\xfb\
    \x02\x02\x1c\x1a\x8f\x01/\x20Cross-program\x20invocation\x20with\x20unau\
    ...
    \n\n\r\n\x05\x05\x01\x02&\x01\x12\x04\xfb\x02\x02\x16\n\r\n\x05\x05\x01\
    \x02&\x02\x12\x04\xfb\x02\x19\x1b\n>\n\x04\x05\x01\x02'\x12\x04\xfe\x02\
    \x02)\x1a0\x20Failed\x20to\x20create\x20program\x20execution\x20environm\
    ent\n\n\r\n\x05\x05\x01\x02'\x01\x12\x04\xfe\x02\x02#\n\r\n\x05\x05\x01\
    \x02'\x02\x12\x04\xfe\x02&(\n*\n\x04\x05\x01\x02(\x12\x04\x81\x03\x02\"\
    \x1a\x1c\x20Program\x20failed\x20to\x20complete\n\n\r\n\x05\x05\x01\x02(\
    \x01\x12\x04\x81\x03\x02\x1c\n\r\n\x05\x05\x01\x02(\x02\x12\x04\x81\x03\
    \x1f!\n)\n\x04\x05\x01\x02)\x12\x04\x84\x03\x02!\x1a\x1b\x20Program\x20f\
    ailed\x20to\x20compile\n\n\r\n\x05\x05\x01\x02)\x01\x12\x04\x84\x03\x02\
    \x1b\n\r\n\x05\x05\x01\x02)\x02\x12\x04\x84\x03\x1e\x20\n$\n\x04\x05\x01\
    \x02*\x12\x04\x87\x03\x02\x11\x1a\x16\x20Account\x20is\x20immutable\n\n\
    \r\n\x05\x05\x01\x02*\x01\x12\x04\x87\x03\x02\x0b\n\r\n\x05\x05\x01\x02*\
    \x02\x12\x04\x87\x03\x0e\x10\n,\n\x04\x05\x01\x02+\x12\x04\x8a\x03\x02\
    \x1b\x1a\x1e\x20Incorrect\x20authority\x20provided\n\n\r\n\x05\x05\x01\
    \x02+\x01\x12\x04\x8a\x03\x02\x15\n\r\n\x05\x05\x01\x02+\x02\x12\x04\x8a\
